export { getColor, getColors } from './color-utils.cjs';
import { ColorParsers, COLORSTRING, RGBCOLORDEF, COLORDEF, RGBVALUE, HEX } from './types.cjs';

declare const colorParsers: ColorParsers[];
/**
 ...
 */
declare function parseColor(colorString: string): RGBVALUE;
/**
...
export { closest, closestRGB, colorParsers, distance, isDark, isLight, parseColor, rgbToHex };
